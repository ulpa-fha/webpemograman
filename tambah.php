...
if (isset($_POST['submit'])) {
    ...
    if (empty($nama) || empty($harga) || empty($kategori) || empty($deskripsi)) {
        ...
        $query = "INSERT INTO menu_makanan (nama_makanan, harga, kategori, deskripsi)
        ...
        <div class="card-body">
            ...
            <form method="post" id="formTambah">
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_makanan" class="form-control" value="<?= isset($nama) ? htmlspecialchars($nama) : '' ?>">
                </div>

                <div class="mb-3">
                    <label class="form-label">Harga</label>
                    <input type="number" name="harga" class="form-control" value="<?= isset($harga) ? htmlspecialchars($harga) : '' ?>">
                </div>

                <div class="mb-3">
                    <label class="form-label">Kategori</label>
                    <input type="text" name="kategori" class="form-control" value="<?= isset($kategori) ? htmlspecialchars($kategori) : '' ?>">
                </div>

                <div class="mb-3">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control" rows="3"><?= isset($deskripsi) ? htmlspecialchars($deskripsi) : '' ?></textarea>
                </div>
...
document.getElementById("formTambah").addEventListener("submit", function(e) {
    ...
    if (!nama || !harga || !kategori || !deskripsi) {
        ...
        errorMsg = "Harga harus berupa angka dan lebih dari 0!";
    }
